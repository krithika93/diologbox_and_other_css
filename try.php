...
{ ?>
<div id="hello" style="height:100px; width:100px; background-color:#00FFFF;opacity:<?php if(isset($GET['count'])) { if($_GET['count'] == 1){ echo "0.4"; } } else { echo "1"; } ?> position:<?php if($_GET['count'] == 1) { echo "absolute"; } else {echo "relative"; } ?> z-index:<?php if($_GET['count'] == 1) { echo "5000"; } else { echo "auto"; } ?> display:<?php if($_GET['count'] == 1) {  echo "block"; } else { echo "none";  } ?>">
...
<div id="hello1" style="background:#FF0000; height:10px;width:10px; opacity:<?php if(isset($GET['count'])) { if($_GET['count'] == 1){ echo "1"; } }else { echo "0";}?> position:<?php if(isset($GET['count'])) { if($_GET['count'] == 1) { echo "absolute"; } } else { echo "relative"; } ?> z-index:<?php if(isset($GET['count'])) { if($_GET['count'] == 1) { echo "5000"; } }  else { echo "auto"; } ?> display:<?php  if(isset($GET['count'])) { if($_GET['count'] == 1) {  echo "block"; } } else { echo "none";  } ?>" >
